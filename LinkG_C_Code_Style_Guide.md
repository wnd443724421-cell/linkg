...
```c
#define LINKG_CELLULAR_DATA_PORT          5003U    // 普通数据UDP端口
#define LINKG_CELLULAR_REALTIME_PORT      5004U    // 实时数据UDP端口
#define LINKG_CELLULAR_VIDEO_PORT         5005U    // 视频数据UDP端口
#define LINKG_CELLULAR_QUEUE_CAPACITY       96U    // 等待队列容量
#define LINKG_CELLULAR_VIDEO_MAX_AGE_US 100000ULL // 视频数据最大等待时间
#define LINKG_CELLULAR_DATA_MAX_AGE_US  200000ULL // 普通数据最大等待时间
```
