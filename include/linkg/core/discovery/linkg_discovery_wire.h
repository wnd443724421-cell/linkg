/**
 * @file linkg_discovery_wire.h
 * @brief LinkG设备发现Wire协议定义
 */

#ifndef LINKG_DISCOVERY_WIRE_H
#define LINKG_DISCOVERY_WIRE_H
...
#define LINKG_DISCOVERY_WIRE_STA_REPORT_SIZE       (LINKG_DISCOVERY_WIRE_HEADER_SIZE + LINKG_DISCOVERY_WIRE_REPORT_SIZE) 		// STA状态报文固定长度
#define LINKG_DISCOVERY_WIRE_PEER_LEAVE_SIZE       (LINKG_DISCOVERY_WIRE_HEADER_SIZE + LINKG_DISCOVERY_WIRE_LEAVE_PAYLOAD_SIZE) // Peer注销报文固定长度
#define LINKG_DISCOVERY_WIRE_AP_SYNC_MAX_SIZE      (LINKG_DISCOVERY_WIRE_HEADER_SIZE + LINKG_DISCOVERY_WIRE_AP_SYNC_BASE_SIZE + LINKG_RESOURCE_NETWORK_STA_MAX * LINKG_DISCOVERY_WIRE_TOPOLOGY_NODE_SIZE) // AP同步报文最大长度
